...
class CartContainerSessionRepoTest extends \Codeception\Test\Unit
{
    ...
    {
        $repository = new SessionRepository('dummy');
        ...
        $this->assertTrue($_SESSION['dummy'] !== null);

        $items = $cart->getItems();
        $this->assertEquals($items, [$item]);
    }
    ...
    public function testAddBeforeEvent()
    {
        ...
        $this->assertEquals(true, $cart->getRepository() instanceof SessionRepository);
